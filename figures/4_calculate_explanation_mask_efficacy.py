...
params = [
          ...
          # {"organelle":"Actomyosin-bundles","model":"../mg_model_bundles_13_05_24_1.0","noise":1.0,"override":True},
          # {"organelle":"Mitochondria","model":"../mg_model_mito_13_05_24_1.5","noise":1.5,"override":True},
          # {"organelle":"Nuclear-envelope","model":"../mg_model_ne_13_05_24_1.0","noise":1.0},
          {"organelle":"Microtubules","model":"../mg_model_microtubules_13_05_24_1.5","noise":1.5,"override":True},
...
base_dir = os.path.join(gv.BASE_PATH, 'full_cells_fovs')
...
for organelle in organelles:
    ...
    if not os.path.exists(ds_path):
      ...
      images_list2 = "{}/train_test_list/{}/image_list_train.csv".format(base_dir,organelle)
      images_list3 = "{}/train_test_list/{}/image_list_test.csv".format(base_dir,organelle)
